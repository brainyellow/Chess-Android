...
public class Mover {
     ...
     */
    public static boolean move(String[] moves, GameBoard gb) {
        int startX, startY, endX, endY;

        String startPos = moves[0];
        String endPos = moves[1];

        startX = Character.getNumericValue(startPos.charAt(0));
        startY = Character.getNumericValue(startPos.charAt(1));

        endX = Character.getNumericValue(endPos.charAt(0));
        endY = Character.getNumericValue(endPos.charAt(1));
        ...
        if (MoveCheck.isValid(startX, startY, endX, endY, gb)) {
            ...
            if (Checkmate.isCheckmate(gb)) {
                ...
                String winner = gb.turnCount % 2 == 0 ? "White Wins!" : "Black Wins!";
